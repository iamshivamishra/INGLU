...
export async function syncJobApplicationToGoogleSheets(
  data: JobApplicationData
) {
  try {
    console.log(
      "JOB_APPLICATION_SHEET_ID:",
      process.env.JOB_APPLICATION_SHEET_ID
    );
    ...
    console.log("Job Application Google Sheets append success");
  } catch (error: any) {
    console.error("Job Application Google Sheets API ERROR");
    console.error("Message:", error?.message);
    console.error("Response:", error?.response?.data);
    throw error;
  }
